<template>
  <div class="my-summary-table">
    ...
    >
      <ul
        class="nav_mine my-summary-head"
        :class="`scroll-${key}`"
      >
        <li
          :class="
            `nav_item my-summary-head-item my-summary-item-col-${headItem.index}`
          "
      ...
      >
        ...
        >
          ...
          <div class="nav_item">
            <ul
              class="pump-color"
              v-for="(pump, pIndex) in tree.pumpsArr"
            >
              <div
              ...
              <div>
                <ul
                  class="pos-color"
                  v-for="(pos, posIndex) in pump.posArr"
                >
                  <div
