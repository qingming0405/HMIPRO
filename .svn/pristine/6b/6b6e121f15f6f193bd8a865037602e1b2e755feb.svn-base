  ...
  <div class="my-system-log select-none box-shadow">
    ...
    >
      ...
      <ul class="my-system-body hide-scroll">
        <li v-for="(body, idx) in data.body" :key="idx">
          ...
          <div class="downloadDiv text-overflow" @click="downLoad(body)">
            <a
              :href="href"
    ...
    >
      <div class="pop-box radius box-shadow" @keyup.13="enter" ref="popBox">
        ...
        >
          添加纪录
          <span class="close-pop" @click.stop="closeAlert(0)">
        ...
        <div class="pop-box-text">
          ...
          <div class="select-time">
            ...
            <input
              class="start-times time-value radius text-overflow select-none"
            />
          </div>
          <!-- 结束时间 -->
          <div class="select-time">
            ...
            <input
              class="end-times time-value radius text-overflow select-none"
            />
          </div>
          <!-- 记录人 -->
          <div class="select-time">
